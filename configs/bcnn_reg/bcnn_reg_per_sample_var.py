base_out_dir = "./outs"
model_type = "BCNNReg"
acq_method = "MCUncertainty"
uncert_method = "per_sample_variance"


out_path = f"{base_out_dir}/{model_type.lower()}/{acq_method}-{uncert_method}/"
...
acquisition=dict(
    function=dict(type=acq_method, uncert_method=uncert_method),
    to_acq_per_iter=10,
    iters=100,
)
